...
subprojects {
    ...
    configure<MavenPublishBaseExtension> {
        ...
        pom {
            ...
            url.set("https://github.com/aSoft-Ltd/bringer")
            licenses {
                license {
                    name.set("MIT License")
                    url.set("https://github.com/aSoft-Ltd/bringer/blob/master/LICENSE")
                }
            }
            developers {
                developer {
            ...
            scm {
                url.set("https://github.com/aSoft-Ltd/bringer/")
                connection.set("scm:git:git://github.com/aSoft-Ltd/bringer.git")
                developerConnection.set("scm:git:ssh://git@github.com/aSoft-Ltd/bringer.git")
            }
        }
    }
}
